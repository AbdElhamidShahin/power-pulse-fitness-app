...
abstract class AppColors {
  ...
  static const Color bgDeep = Color(0xFFF5F5F0);
  static const Color bgSurface = Color(0xFFFFFFFF);
  static const Color bgElevated = Color(0xFFEFEFEF);
  static const Color bgHighest = Color(0xFFE8E8E8);

  static const Color bgDark = Color(0xFF1A1A1A);
  static const Color bgDarkAlt = Color(0xFF2A2A2A);
...
class _AppColorSet {
  ...
  Color get bgElevated =>
      _dark ? const Color(0xFF242424) : AppColors.bgElevated;
  Color get textPrimary =>
      _dark ? const Color(0xFFF5F5F0) : AppColors.textPrimary;
  Color get textSecondary =>
      _dark ? const Color(0xFFB0B0B0) : AppColors.textSecondary;
  Color get textMuted => _dark ? const Color(0xFF6B6B6B) : AppColors.textMuted;
  Color get borderSubtle =>
      _dark ? const Color(0xFF2A2A2A) : AppColors.borderSubtle;
}
